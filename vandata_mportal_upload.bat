...
SET BATLOGFILE=%~dp0log\vandata_mportal_upload.log
SET BATLOGTEMP=%~dp0log\vandata_mportal_upload_tmp.log
SET yyyyMMdd=%date:/=%
SET hhmmss=%time: =0%
