...
SET BATLOGFILE=%~dp0log\juchu_mportal_download_log.log
SET BATLOGTEMP=%~dp0log\juchu_mportal_download_log_tmp.log
SET yyyyMMdd=%date:/=%
SET hhmmss=%time: =0%
